...
<html>
    ...
    <h1><a href='admin_insert_panel.php'>Add new details</br></a></h1>
    <hr>
    <a href='admin_smallanimals.php?admin_smallanimals'>Small Animals</a>
    <hr>
    <a href='admin_largeanimals.php?admin_largeanimals'>Large Animals</a>
    <hr>
    <a href='admin_senioranimals.php?admin_senioranimals'>Senior Animals</a>
    <hr>
    ...
    <?php 
        ...
        else
        {
            ...
            foreach($fetches as $values)
            {
                ...
                "Farm name:"." ".$values["farm_name"]."</br>"."Location:"." ".$values["city"]."</br>"."Zip code:"." ".$values["zip_code"]."</br>"."Address:"." ".$values["farm_address"].
                "</br>"."Animal image:"." ".$values["animal_image"]."</br>"."Farm image:"." ".$values["farm_image"]."</br>"."<a href='admin_update_panel.php?update_panel=".$values["animal_id"].
                "'>Update</a>"."</br><a href='admin_delete.php?admin_delete=".$values["animal_id"]."'>Delete</a></br>";    
